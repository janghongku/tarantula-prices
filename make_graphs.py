...
def main():
    ...
    if args.demo:
        demo = [
            ("상히에 아일랜드 블랙", "거미랑 / 네이버", [["2026-05-10", 3000], ["2026-05-20", 8000], ["2026-05-28", 6000], ["2026-06-01", 14000]]),
            ("코스타리칸 레드렉", "거미랑 / 네이버", [["2026-05-12", 120000], ["2026-05-25", 139000], ["2026-06-01", 165000]]),
            ("바히아 퍼플레드", "타란툴라코리아 / 네이버", [["2026-05-15", 18000], ["2026-05-22", 25000], ["2026-06-01", 38000]]),
            ("킹바분", "타란툴라코리아 / 네이버", [["2026-05-11", 13000], ["2026-05-20", 11000], ["2026-05-30", 15000], ["2026-06-01", 18000]]),
            ("판케이 타이거", "타란툴라코리아 / 네이버", [["2026-05-14", 23000], ["2026-05-26", 28000], ["2026-06-01", 35000]]),
        ]
